...
class GoogleDrive {
    ...
    public static function uploadFile($title,$type,$file,$folder=null,$convert=false)
    {
		...
		if ($file_size < $chunk_size) {
			...
			$ret=self::request($url,'POST',$body.file_get_contents($file).$post,'','',null,$header);
