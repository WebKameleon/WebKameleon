...
abstract class elFinderVolumeDriver {
	...
	public function upload($fp, $dst, $name, $tmpname) {
        ...
        */
        ...
        // SIM: tak chyba powinno byc...
        if (strtolower($this->uploadOrder[0]) == 'allow') {
            $upload = $this->mimeAccepted($mime, $this->uploadAllow, null);
        } else {
            $upload = $this->mimeAccepted($mime, $this->uploadDeny,  null);
        }
