function dhtmlXCalendarObject(inps, skin) {
    ...
    this._getInd = function (val, ar) {
        for (var q = 0; q < ar.length; q++) if (ar[q].toLowerCase() == val) {
            return q;
        }
        return -1;
    }
...
dhtmlXCalendarObject.prototype.langData = {
    ...
    "pl": {
        ...
        monthesSNames: ["Sty", "Lut", "Mar", "Kwi", "Maj", "Cze", "Lip", "Sie", "Wrz", "Paź", "Lis", "Gru"],
        daysFNames: ["Niedziela", "Poniedziałek", "Wtorek", "Środa", "Czwartek", "Piątek", "Sobota"],
        daysSNames: ["Nd", "Pon", "Wt", "Śr", "Czw", "Pt", "So"],
        weekstart: 1,
        weekname: "w"
    }
};
